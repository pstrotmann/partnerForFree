...
class gsp_partner_historieedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/historie/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',27,['bean':(historieInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(historieInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(historieInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:historieInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
