...
class gsp_partner_hausadresseindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/hausadresse/index.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',45,['action':("show"),'id':(hausadresseInstance.id)],3)
printHtmlPart(17)
...
printHtmlPart(19)
invokeTag('paginate','g',62,['total':(hausadresseInstanceCount ?: 0)],-1)
printHtmlPart(20)
})
