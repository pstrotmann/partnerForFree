...
class gsp_partner_emailcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/email/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('message','g',18,['code':("default.send.label"),'args':([entityName])],-1)
printHtmlPart(8)
...
invokeTag('eachError','g',26,['bean':(emailInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',28,['bean':(emailInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('render','g',31,['template':("/emailEmpfaenger/form2"),'model':(['emailEmpfaengerInstance':new EmailEmpfaenger()])],-1)
printHtmlPart(20)
