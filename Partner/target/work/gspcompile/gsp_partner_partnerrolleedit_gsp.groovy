...
class gsp_partner_partnerrolleedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(partnerrolleInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:partnerrolleInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
