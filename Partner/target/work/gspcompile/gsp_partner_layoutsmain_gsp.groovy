...
class gsp_partner_layoutsmain_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(7)
invokeTag('image','asset',20,['src':("pLogo.png"),'alt':("Grails")],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1421677520000L
