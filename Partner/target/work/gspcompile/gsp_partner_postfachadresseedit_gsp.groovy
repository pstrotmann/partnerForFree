...
class gsp_partner_postfachadresseedit_gsp extends GroovyPage {
...
printHtmlPart(23)
invokeTag('actionSubmit','g',39,['class':("list"),'action':("plz"),'value':(message(code: 'default.button.plz.label', default: 'plz bestimmen'))],-1)
printHtmlPart(24)
})
invokeTag('form','g',41,['method':("put")],2)
printHtmlPart(25)
})
