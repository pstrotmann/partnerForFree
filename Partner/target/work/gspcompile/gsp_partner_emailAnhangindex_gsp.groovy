...
class gsp_partner_emailAnhangindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/emailAnhang/index.gsp" }
public Object run() {
Writer out = getOut()
...
loop:{
int i = 0
for( emailAnhangInstance in (emailAnhangInstanceList) ) {
printHtmlPart(15)
...
printHtmlPart(17)
expressionOut.print(fieldValue(bean: emailAnhangInstance, field: "eMail"))
printHtmlPart(18)
i++
}
}
printHtmlPart(19)
invokeTag('paginate','g',46,['total':(emailAnhangInstanceCount ?: 0)],-1)
printHtmlPart(20)
})
