		...
		<div id="show-lastschriftmandat" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:lastschriftmandatInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					...
					<a id="pdf-link" class="print" href="#pdf-link" onClick="javascript:window.open('<g:createLink action="renderFormPDF" id="${lastschriftmandatInstance?.id}"/>','_blank','width=1000, height=1200')">Drucken</a>
				</fieldset>
			</g:form>
		</div>
	</body>
